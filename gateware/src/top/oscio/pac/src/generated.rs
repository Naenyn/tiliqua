...
pub mod line;
#[doc = "scope_periph"]
pub type SCOPE_PERIPH = crate::Periph<scope_periph::RegisterBlock, 0xf000_1100>;
impl core::fmt::Debug for SCOPE_PERIPH {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("SCOPE_PERIPH").finish()
    }
}
#[doc = "scope_periph"]
...
impl core::fmt::Debug for OVERLAY_PERIPH {
    fn fmt(&self, f: &mut core::fmt::Formatter) -> core::fmt::Result {
        f.debug_struct("OVERLAY_PERIPH").finish()
    }
}
#[doc = "overlay_periph"]
pub mod overlay_periph;
#[no_mangle]
