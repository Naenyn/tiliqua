...
def put_native_feedback_labels(put):
    ...
    put(1, "BANDS", 8, 16)
    put(1, "FREQ:", 23, 16)
    put(1, "FEEDBACK", NATIVE_FEEDBACK_LABEL_X, NATIVE_FEEDBACK_AMOUNT_ROW)
    put(1, "FEEDBACK SAFETY", 8, NATIVE_FEEDBACK_SAFETY_TITLE_ROW)
    put(1, "KNEE", NATIVE_FEEDBACK_LABEL_X + 3, NATIVE_FEEDBACK_KNEE_ROW)
    put(1, "CEILING", NATIVE_FEEDBACK_LABEL_X,
        NATIVE_FEEDBACK_CEILING_ROW)
    put(1, "DAMPING", NATIVE_FEEDBACK_LABEL_X,
