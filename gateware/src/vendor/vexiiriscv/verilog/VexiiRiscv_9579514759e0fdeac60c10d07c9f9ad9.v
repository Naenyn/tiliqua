...
module VexiiRiscv (
  ...
  assign LsuCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|{((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hffff0000) == 32'hf0000000),((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hffffc000) == 32'h0)}) && (|LsuCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
  ...
  assign FetchCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|((FetchCachelessPlugin_pmaBuilder_addressBits & 32'hffffc000) == 32'h0)) && (|FetchCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
  ...
  assign execute_freeze_valid = (|{CsrAccessPlugin_logic_fsm_inject_freeze,{(execute_ctrl3_down_LsuCachelessPlugin_WITH_RSP_lane0 && (! LsuCachelessPlugin_logic_onJoin_rspValid)),{LsuCachelessPlugin_logic_onFork_freezeIt,early0_IterativeShifterPlugin_logic_shift_freezeIt}}});
