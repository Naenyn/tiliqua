...
module VexiiRiscv (
  ...
  assign LsuCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|{((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hffff0000) == 32'hf0000000),((LsuCachelessPlugin_pmaBuilder_addressBits & 32'hffff0000) == 32'h0)}) && (|LsuCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
  ...
  assign FetchCachelessPlugin_logic_onPma_port_rsp_fault = (! ((|((FetchCachelessPlugin_pmaBuilder_addressBits & 32'hffff0000) == 32'h0)) && (|FetchCachelessPlugin_pmaBuilder_onTransfers_0_hit)));
